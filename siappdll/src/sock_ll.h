...
extern "C" int __fastcall l_connect_int80h(int sockfd, const struct sockaddr* addr, unsigned int addrlen);
extern "C" int __fastcall l_read_int80h(int fd, char* buf, unsigned int count);
extern "C" int __fastcall l_close_int80h(int fd);
